...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['signatureImageFile'], 'image', 'extensions' => 'png, jpg, jpeg'/*, 'maxSize' => 10 * 1024 * 1024*/], //10mb
        ];
    }
    ...
    public function save($runValidation = true, $attributeNames = null) 
    {
        if(!$this->isNewRecord) {
            if($this->signatureImageFile) {
                ...
                $this->signature_image =  Yii::getAlias('/users/'.$this->signatureImageFile->name);
            }

            $transaction = Yii::$app->db->beginTransaction();
            $ok = parent::save($runValidation, $attributeNames);

            if($ok && $this->signature_image) {
                $fullPath = Yii::getAlias('@backend/web/storage'.$this->signature_image);
                $dir = dirname($fullPath);
                if(!FileHelper::createDirectory($dir) | !$this->signatureImageFile->saveAs($fullPath)) {
    ...
    public function getImageUrl() 
    {
        ...
        return Yii::$app->params['backendUrl'].'/storage'.$this->signature_image.'?v='.time();
    }
