...
<h3>Title: <?=$quotationModel->doc_name;?></h3>

<?php 
echo $this->render('/quotation/product', [
...
$js = <<<JS
    $(document).on('click', '#preview-quotation-btn', function(){
        window.open('generate-pdf?id=$id&format=raw', '_blank');
    });
