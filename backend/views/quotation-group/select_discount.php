...
echo GridView::widget([
    ...
    'afterFooter'=>'
        ...
        <tr class="table-warning kv-page-summary"><td colspan="4" align="right">Discount (%)</td><td align="right"><input type="text" name="Quotation[total_discount]" style="text-align: right" value="'.$grand_total_discount.'"/></td></tr>
    ',
    ...
    'panel' => [
        ...
        'heading' => $heading,
        'after'=>Html::a('<i class="fas fa-save"></i> Apply Discount', ['/quotation-group/apply-discount', 'id' => Yii::$app->request->get('id')], [
